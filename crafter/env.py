...
DiscreteSpace = spaces.Discrete
BoxSpace = spaces.Box
DictSpace = spaces.Dict
BaseClass = GymnasiumEnv
...
class Env(BaseClass):
    ...
    def __init__(
        ...
        # Gymnasium metadata conventions
        self.metadata = {
    ...
    def reset(self, seed=None, options=None):
        # Gymnasium passes seed to reset; still support our internal seeding.
        if seed is not None:
            # Use provided seed for deterministic episode initialization.
            self._seed = int(seed)
